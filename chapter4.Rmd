...
K-means clustering algorithm invoked here will place each of the observations in 4 clusters
...
Here we can see the paiwise plot of the clusters  and the variables.
```{r echo=TRUE}
...
9. ###  model predictors and lda.fit$scaling for the "crime variable"
...
We use the cluster_boston data set and use the lda.fit.cluster the model we trainedwhen the predictand is the  km$cluster obtained from the kmeans algorithm.
